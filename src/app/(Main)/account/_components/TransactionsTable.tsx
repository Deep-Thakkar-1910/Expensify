...
const RECURRING_INTERVALS: RecurringType = {
  DAILY: "Daily",
  WEEKLY: "Weekly",
  MONTHLY: "Monthly",
};
                        ...
                        <Tooltip>
                          <TooltipTrigger>
                            ...
                            >
                              ...
                              {
                                RECURRING_INTERVALS[
                                  transaction.recurringInterval as keyof RecurringType
                                ]
                              }
                            </Badge>
                          </TooltipTrigger>
                          <TooltipContent>
                            <div className="text-sm">
                              ...
                              <div>
                                {format(
                                  new Date(
                                    transaction.nextRecurring as unknown as string,
                                  ),
                                  "PPP",
                                )}
                              </div>
                      ...
                      <DropdownMenuContent align="end">
                        {transaction.isRecurring && (
                          <DropdownMenuItem
                            onClick={() =>
                              router.push(
                                `/transaction-create?edit=${transaction.id}${transaction.isRecurring ? "&isChangeAmount=true" : ""}`,
                              )
                            }
                          >
